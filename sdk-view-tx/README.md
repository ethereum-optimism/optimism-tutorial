...
This tutorial teaches you how to use [the Optimism SDK](https://sdk.optimism.io/) to view the transactions passed between L1 (Ethereum Mainnet or Goerli) and L2 (OP Mainnet or OP Goerli) by an address.
